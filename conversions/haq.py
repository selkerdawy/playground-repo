...
# Source of Code: https://github.com/mit-han-lab/haq
...
def convert(module, **kwargs):
    if isinstance(module, torch.nn.Conv2d):
        ...
        quant_module = QConv2d(module.in_channels, module.out_channels, module.kernel_size, module.stride, module.padding, module.dilation, module.groups, module.bias is not None,
                              **kwargs)
    elif isinstance(module, torch.nn.Linear):
        # Initialize from an existing torch.nn.Linear layer
        quant_module = QLinear(module.in_features, module.out_features, bias=module.bias is not None,
                               **kwargs)
